...
public class StringUtils {
    ...
    public static final String PRODUCT_MENU = "\"1. View-Products \n2. Add-Products \n3. Edit-Products \n4. Delete \n99. Back";
    ...
    public static final String FILE_NOT_FOUND = "!!!!!File is not Found on the given path!!!!!";
    ...
    public static final String EMAIL_USED = "This Email is already registered.....\n" + "Please login with your email address";
}
